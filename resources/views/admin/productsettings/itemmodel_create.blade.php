    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <div class="card c-shadow">
                <div class="card-body ">
                    <h5 class="card-title">Create Item Model</h5>
                    @if ($errors->any())
                    ...
                    @endif
                    <form action='{{ route('itemmodel_store') }}' method="post" enctype="multipart/form-data"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" placeholder="Item Model NO" class="form-control" name ="model_no" id="validationTooltip01"  >
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-12 mt-3 mb-3">
                            ...
                            <a  href="{{ route('item_model_list') }}"><span class="btn btn-primary">Go To List</span></a>
                        </div>
                    </form>
                </div>
            </div>
